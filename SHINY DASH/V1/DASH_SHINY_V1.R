...
#setwd("C:/Users/user/Documents/PROJETOS/R/DASHBOARD/SHINY DASH/V1")
path <- "CONJUNTO DE DADOS/DATA_GEN_V1.csv"
...
server <- function(input, output) {
  ...
  VENDAS.DF <- read_csv("CONJUNTO DE DADOS/DATA_GEN_V1.csv")
  ...
  output$city_map <- renderLeaflet({
    ...
    path <- "CONJUNTO DE DADOS/GEOPA.rds"
