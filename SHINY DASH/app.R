    ...
    df.filter2() %>%
      ...
      e_tooltip(trigger = "item",
                ...
                function(params) {
                  ...
                  res += 'Mínimo: ' + new Intl.NumberFormat('pt-BR').format(params.value[1]) + '<br/>';
                  res += 'Q1: ' + new Intl.NumberFormat('pt-BR').format(params.value[2]) + '<br/>';
                  res += 'Mediana: ' + new Intl.NumberFormat('pt-BR').format(params.value[3]) + '<br/>';
                  res += 'Q3: ' + new Intl.NumberFormat('pt-BR').format(params.value[4]) + '<br/>';
                  res += 'Máximo: ' + new Intl.NumberFormat('pt-BR').format(params.value[5]) + '<br/>';
                  return res;
                }
              ")) %>%
